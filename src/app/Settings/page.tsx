...
function Settings() {
 ...
 <main className=" md:my-auto md:mt-auto lg:mt-auto justify-center items-center min-h-screen min-y-screen ">
  <div className='absolute p-8 rounded-md shadow-xl shadow-drop shadow-black ml-2 duration-500 '>
    <div className=' text-2xl italic text-center font-bold italic rounded-md bg-gray '>
      Settings
    </div>
          ...
          <RiProfileLine
            ...
            {isDropdownOpen2 && (
              <div className="mt-2 rounded-md shadow-xl ">
                  <ul>
                    <button className='flex rounded rounded-md hover:bg-gray-500' onClick={openModal2}>
                    <BsKey
                      className=" left-8"
                      size={25}
                    />
                  ...
                  {isModalOpen2 && (
                   <div className="absolute p-8 translate-x-40 top-20 rounded-md h-300 shadow-xl shadow-inner  bg-gray-300 text-black" style={{ width: '300px',  height:'200px'}}>
                   ...
                   <ul>
                    <button className='flex rounded rounded-md hover:bg-gray-500 mt-2'onClick={openModal}>
                      <FaUserCog
                        className=" left-8"
                        size={25}
                      />
                  ...
                  {isModalOpen && (
                   <div className="absolute p-8 translate-x-40 top-20 rounded-md h-300 shadow-xl shadow-inner  bg-gray-300 text-black" style={{ width: '300px',  height:'300px'}}>
                    ...
                    <ul>
                    <button className='flex rounded rounded-md hover:bg-gray-500 mt-2'onClick={openModal1}>
                    <BsTelephoneFill
                      className=" left-8"
                      size={20}
                    />
