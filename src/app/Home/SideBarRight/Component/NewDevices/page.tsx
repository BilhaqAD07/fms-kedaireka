...
function NewDevices({ openDialog, setOpenDialog }) {
  ...
  return (
    <div className="bg-white dark:bg-secondary_dark">
      <Dialog
        open={openDialog}
      ...
      >
        <Stack
          className="bg-white dark:bg-secondary_dark"
          direction={"row"}
          alignItems="center"
        ...
        <DialogContent className="bg-white dark:bg-secondary_dark">
          <TextField
            error={isError.error}
        ...
        <DialogActions className="bg-white dark:bg-secondary_dark">
...
const DevicePropertiesComponent = ({
  ...
  return (
    ...
    >
      <Stack className="bg-white dark:bg-secondary_dark" spacing={1} direction="row" alignItems="center">
